...
import { TYPOGRAPHY_H1, TYPOGRAPHY_H1_SUB, TYPOGRAPHY_BIG_NUMBER } from '@/constants/designTokens';
            ...
            <Container>
                <div className="max-w-5xl mx-auto w-full flex flex-col gap-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className={`${TYPOGRAPHY_H1} text-white`}>在庫監視</h1>
                ...
                <div className="max-w-5xl mx-auto w-full flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-app-surface border border-app-border rounded-xl p-5">
                            ...
                            <p className={`${TYPOGRAPHY_BIG_NUMBER} text-白`}>0</p>
                        </div>
                        <div className="bg-app-surface border border-app-border rounded-xl p-5">
