...
import { TYPOGRAPHY_H1, TYPOGRAPHY_H1_SUB, TYPOGRAPHY_CARD_TITLE } from '@/constants/designTokens';
...
export default function Settings() {
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-app-base text-app-text-main">
            <Container>
                <div className="flex flex-col gap-2">
                    <h1 className={`${TYPOGRAPHY_H1} text-white`}>設定</h1>
                    <p className={`${TYPOGRAPHY_H1_SUB} max-w-2xl`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="p-6 bg-app-surface border-app-border">
                        <h3 className={`${TYPOGRAPHY_CARD_TITLE} text-white mb-4`}>バージョン情報</h3>
                    ...
                    <Card className="p-6 bg-app-surface border-app-border">
                        <h3 className={`${TYPOGRAPHY_CARD_TITLE} text-white mb-4`}>アップデート</h3>
                ...
                <div className="opacity-30 pointer-events-none grayscale select-none">
                    <Card className="p-6 bg-app-surface border-app-border space-y-6">
                        <div className="space-y-4">
                            <h3 className={`${TYPOGRAPHY_CARD_TITLE} text-white`}>抽出対象 (プレビュー)</h3>
